      ...
      <div class="col-container container--donate">
        <div class="col-inline inline--donate">
          <div class="col-middle">
            <div class="col donate__content donate__content--active donate"><i class="icon icon--big">
                <svg role="img">
                  <use xlink:href="../src/img/all.svg#donate"></use>
                </svg></i>
              <div class="content-headline">Spenden</div>
            </div>
            <div class="col donate__content join"><i class="icon icon--big">
                <svg role="img">
          ...
          <div class="col-middle">
            <div class="col col--8 donate-text__content">
              ...
              <div class="donate-box">
                <div class="donate-box__header"><i class="icon">
                    <svg role="img">
            ...
            <div class="col col--4 image donate-text__image"><img src="../../src/img/donate.jpg" alt=""></div>
          </div>
        </div>
      </div>
      <footer class="footer"> 
